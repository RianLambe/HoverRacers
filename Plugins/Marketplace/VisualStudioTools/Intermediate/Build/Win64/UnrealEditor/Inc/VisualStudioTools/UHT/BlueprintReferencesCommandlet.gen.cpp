...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVsBlueprintReferencesCommandlet_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "BlueprintReferencesCommandlet.h" },
		{ "ModuleRelativePath", "Private/BlueprintReferencesCommandlet.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UVsBlueprintReferencesCommandlet_Statics::StaticCppClassTypeInfo = {
	...
	struct Z_CompiledInDeferFile_FID_Users_rianl_Documents_GitHub_DingleSting_PodRacing_Plugins_Marketplace_VisualStudioTools_Source_VisualStudioTools_Private_BlueprintReferencesCommandlet_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_rianl_Documents_GitHub_DingleSting_PodRacing_Plugins_Marketplace_VisualStudioTools_Source_VisualStudioTools_Private_BlueprintReferencesCommandlet_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVsBlueprintReferencesCommandlet, UVsBlueprintReferencesCommandlet::StaticClass, TEXT("UVsBlueprintReferencesCommandlet"), &Z_Registration_Info_UClass_UVsBlueprintReferencesCommandlet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVsBlueprintReferencesCommandlet), 2652012655U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_rianl_Documents_GitHub_DingleSting_PodRacing_Plugins_Marketplace_VisualStudioTools_Source_VisualStudioTools_Private_BlueprintReferencesCommandlet_h_2886281555(TEXT("/Script/VisualStudioTools"),
		Z_CompiledInDeferFile_FID_Users_rianl_Documents_GitHub_DingleSting_PodRacing_Plugins_Marketplace_VisualStudioTools_Source_VisualStudioTools_Private_BlueprintReferencesCommandlet_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_rianl_Documents_GitHub_DingleSting_PodRacing_Plugins_Marketplace_VisualStudioTools_Source_VisualStudioTools_Private_BlueprintReferencesCommandlet_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
